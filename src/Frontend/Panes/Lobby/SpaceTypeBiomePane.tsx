...
export function SpaceTypeBiomePane({ config, onUpdate }: LobbiesPaneProps) {
  return (
    <>
      <Row>
        Space types affect the defense, speed, range, and upgrade potential of
        planets that exist within them. Nebula and Space increase defense of
        planets, while Dead Space increases planet speed.
      </Row>
      <Row>
        <Checkbox
