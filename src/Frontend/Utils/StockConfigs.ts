...
const vanilla: LobbyInitializers = {
  ...
  PLANET_LEVEL_THRESHOLDS: [
    4194293, 4194292, 1048561, 262128, 65520, 16368, 4080, 1008, 240, 48,
  ],
  PLANET_RARITY: 7000,
  ...
  CAPTURE_ZONE_PLANET_LEVEL_SCORE: [
    0, 0, 250000, 500000, 750000, 1000000, 10000000, 20000000, 50000000,
    100000000,
  ],
...
const fourPlayerBattle: LobbyInitializers = {
  ...
  SILVER_SCORE_VALUE: 10,
  PLANET_LEVEL_THRESHOLDS: [
    1048563, 1048562, 1048561, 262128, 65520, 16368, 4080, 1008, 240, 48,
  ],
  PLANET_RARITY: 9000,
